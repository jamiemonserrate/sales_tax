...
describe ShoppingBasket do
  context '#add' do
    it 'should respond to add' do
      expect { ShoppingBasket.new.add(1, FactoryGirl.build(:item)) }.to_not raise_error
    end
  end
  ...
  context '#print_receipt' do
    it 'should be able to print receipt' do
      ...
      shopping_basket.add(1, Item.new('book 1', 123.0))
      shopping_basket.add(1, Item.new('book 2', 456.0))
